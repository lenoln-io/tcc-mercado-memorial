...
public class MinhaContaPJVIEW extends javax.swing.JFrame implements IVIEW {
    ...
    private void preencherCampos() {
        ...
        objetoPessoaJuridica = controlePessoaJuridica.pesquisar(objetoUsuario.getPessoa().getId());
    ...
    private void initComponents() {
        ...
        setTitle("Meus dados - Pessoas jurídicas");
        setResizable(false);
        ...
        btCancelar.setName("btCancelareusDados"); // NOI18N
        ...
        btDesativarConta.setToolTipText("<html>Dessativar conta<br />Atalho: alt + d</html>");
    ...
    private void btSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarActionPerformed
        ...
        if(temp == JOptionPane.YES_NO_OPTION){
            ...
            if(!txtEmail.getText().isEmpty() && !txtNome.getText().equals("") && txtCnpj.getText().length() == 18){
                                ...
                                if(objetoPessoaJuridica.getEnderecos() != null && !objetoPessoaJuridica.getEnderecos().isEmpty()){
                                    ...
                                    if(!liModel.isEmpty()){
                                        ...
                                        if(senhaok == true){
                                            ...
                                            JOptionPane.showMessageDialog(null,"Seus dados foram atualizados com sucesso.","OK",JOptionPane.PLAIN_MESSAGE);
