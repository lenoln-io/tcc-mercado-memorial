...
public class PessoaFisicaVIEW extends javax.swing.JFrame implements IVIEW {
    ...
    private void preencherFiltroCampos() {
        ...
        for (int i = 0; i < modeloTabelaPessoaFisica.getColumnCount(); i++) {
            cbxCampos.addItem(new CampoFiltro(
                modeloTabelaPessoaFisica.getColumnName(i), modeloTabelaPessoaFisica.getnomeTabela(i),
                modeloTabelaPessoaFisica.getNomeColunaTabela(i),
                modeloTabelaPessoaFisica.getTipoColunaTabela(i))
            );
        }
    ...
    private void carregarTabela() {
        ...
        modeloTabelaPessoaFisica.Recarregar(controlePessoaFisica.pesquisaPersonalizada("pessoa > 0 and pessoa <> "+ul.getPessoa().getId()));
        tbPessoaFisicas.setModel(modeloTabelaPessoaFisica);
    }

    private void carregarTabela(List<PessoaFisicaEntity> filtrar) {
        UsuarioEntity ul = new UsuarioBLL().pesquisar(Login.getLogin());
        ...
        modeloTabelaPessoaFisica.Recarregar(filtrar);
        tbPessoaFisicas.setModel(modeloTabelaPessoaFisica);
    }
    ...
    private void limparCampos() {
        objetoPessoaFisica = null;
        txtNome.setText("");
        txtCpf.setText("");
        txtDtnasc.setDate(null);
        tbPessoaFisicas.clearSelection();
    ...
    private void controlarCampos(boolean condicao) {
        ...
        tbPessoaFisicas.setEnabled(!condicao);
    }
    ...
    private void preencherCampos() {
        objetoPessoaFisica = modeloTabelaPessoaFisica.getObjeto(tbPessoaFisicas.getSelectedRow()).getClone();
    ...
    private final PessoaFisicaTableModel modeloTabelaPessoaFisica = new PessoaFisicaTableModel();
    ...
    private void initComponents() {
        ...
        tbPessoaFisicas = new javax.swing.JTable();
        ...
        btNovo.setName("btNovoPessoaF"); // NOI18N
        ...
        btSalvar.setName("btSalvarPessoaF"); // NOI18N
        ...
        btEditar.setName("btEditarPessoaF"); // NOI18N
        ...
        btExcluir.setName("btExcluirPessoaF"); // NOI18N
        ...
        btCancelar.setName("btCancelarPessoaF"); // NOI18N
        ...
        jLabel14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icones/frigocenter-cadastro-cliente-pf.jpg"))); // NOI18N
            ...
            .add(jPanel4Layout.createSequentialGroup()
                ...
                .add(jPanel4Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(jPanel4Layout.createSequentialGroup()
                        ...
                        .add(0, 0, Short.MAX_VALUE))
                    .add(jLabel14, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 380, Short.MAX_VALUE))
                .addContainerGap())
        );
        ...
        tbPessoaFisicas.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        tbPessoaFisicas.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        tbPessoaFisicas.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                tbPessoaFisicasMousePressed(evt);
            }
        });
        tbPessoaFisicas.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                tbPessoaFisicasKeyReleased(evt);
            }
        });
        spTabela.setViewportView(tbPessoaFisicas);
    ...
    private void btEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditarActionPerformed
        ...
        UsuarioEntity ul = new UsuarioBLL().pesquisar(Login.getLogin());
        List<UsuarioEntity> usuario = new UsuarioBLL().pesquisaPersonalizada("pessoa = "+objetoPessoaFisica.getId());
    ...
    private void btExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btExcluirActionPerformed
        ...
        String sql = "select distinct usuarios.* from usuarios, pessoas where usuarios.pessoa = pessoas.id "
                + "and pessoas.id = "+objetoPessoaFisica.getId()+";";
        List<UsuarioEntity> resultado = new UsuarioBLL().sqlDeConsultaPersonalizada(sql);
        if(resultado == null || resultado.isEmpty()){
            
            boolean perguntar = false;
            List<OperacaoEntity> resp = new OperacaoBLL().pesquisaPersonalizada("idpessoa = "+objetoPessoaFisica.getId());
            ...
            if(perguntar == false){
                ...
                temp = JOptionPane.showConfirmDialog(null,"Essa pessoa está associada há uma ou mais vendas.\n"
            ...
            if (temp == JOptionPane.YES_OPTION) {
                ...
                ul.setDescricao("Excluiu a pessoa física de nome = "+objetoPessoaFisica.getNome()+" e de ID = "+objetoPessoaFisica.getId());
                ...
                controlePessoaFisica.excluir(objetoPessoaFisica);
                carregarTabela();
                limparCampos();
                situacao = situacaoCadastro.scEsperando;
                controlarBotoes();
    ...
    private void btExcelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btExcelActionPerformed
        ...
        try {
            ...
            if (retorno == JFileChooser.APPROVE_OPTION) {
                ...
                exportarExcel.GerarArquivo(tbPessoaFisicas, new File(caminho));
        ...
        if(!txtCriterio.getText().equals("")){
            ...
            if("int".equals(criterio.getCampo().getTipoColuna())){
                try{
                    ...
                    carregarTabela(new PessoaFisicaBLL().filtrar(criterio));
                }
    ...
    private void btListarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btListarActionPerformed
        ...
        carregarTabela(new PessoaFisicaBLL().listarTodos());
        
    }//GEN-LAST:event_btListarActionPerformed

    private void tbPessoaFisicasMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbPessoaFisicasMousePressed
        
        if(tbPessoaFisicas.isEnabled()){
            carregarTabelaEndereco(null);
    ...
    }//GEN-LAST:event_tbPessoaFisicasMousePressed
    ...
    private void btSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarActionPerformed
        ...
        if(temp == JOptionPane.YES_NO_OPTION){
            ...
            List<PessoaFisicaEntity> resultado;
            
            if(situacao == situacaoCadastro.scInserindo){
                resultado = controlePessoaFisica.pesquisaPersonalizada("cpf = '"+txtCpf.getText()+"'");
            }else{
                resultado = controlePessoaFisica.pesquisaPersonalizada("cpf = '"+txtCpf.getText()+"' and pessoa <> "+objetoPessoaFisica.getId());
            }
            
            if(resultado == null || resultado.isEmpty()){
                if(!txtNome.getText().equals("") && txtCpf.getText().length() == 14 && txtDtnasc.getDate() != null && (rbFem.isSelected() || rbMasc.isSelected())){
                        ...
                        if(objetoPessoaFisica.getEnderecos() != null && !objetoPessoaFisica.getEnderecos().isEmpty()){
                            ...
                            if(!liModel.isEmpty()){
                                ...
                                if (situacao == situacaoCadastro.scInserindo) {
                                    ...
                                    ul.setDescricao("Cadastrou a pessoa física de nome = "+objetoPessoaFisica.getNome()+" e de ID = "+objetoPessoaFisica.getId());
                                    ul.setUsuario(new UsuarioBLL().pesquisar(Login.getLogin()));
                                    ul.setHorario(DataUtility.getDateTime("EN"));
                                    new UsuarioAcaoBLL().salvar(ul);
                                    ...
                                    ul.setDescricao("Alterou a pessoa física de ID = "+objetoPessoaFisica.getId());
                                    ul.setUsuario(new UsuarioBLL().pesquisar(Login.getLogin()));
                                    ul.setHorario(DataUtility.getDateTime("EN"));
                                    new UsuarioAcaoBLL().salvar(ul);
    ...
    private void tbPessoaFisicasKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbPessoaFisicasKeyReleased
    ...
    }//GEN-LAST:event_tbPessoaFisicasKeyReleased
    ...
    private javax.swing.JTable tbPessoaFisicas;
